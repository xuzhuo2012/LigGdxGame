...
public class Drop implements ApplicationListener {
  ...
  // Sound dropSound;
   ...
   public void create() {
      ...
      dropImage = new Texture(Gdx.files.internal("asset/11.png"));
      bucketImage = new Texture(Gdx.files.internal("asset/11.png"));
      
      // load the drop sound effect and the rain background "music"
     // dropSound = Gdx.audio.newSound(Gdx.files.internal("asset/tonight.mp3"));
      rainMusic = Gdx.audio.newMusic(Gdx.files.internal("asset/tonight.mp3"));
